...
def main():
    ...
    df_par=df[['risetime','simm','area','ae']]
    ...
    clusters=3
    n_data=0
    name='/home/marco/work/tesi/data/FCM_'
    if(crioconite):
    ...
    if(train):
        ...
        #file_name = '/home/marco/work/tesi/data/model.pkl'
    ...
    if(fit):
        if(crioconite):
            file_name ='/home/marco/work/tesi/data/FCM_Crioconite_c3_e1550_model_0.pkl'        
          
        else:
            file_name ='/home/marco/work/tesi/data/FCM_228Th_c3_e1550_model_0.pkl'
    ...
    plt.legend()
    plt.xlabel('ae')
    plt.ylabel('Counteggi Normalizzati')
    plt.show()
