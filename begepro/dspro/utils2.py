...
class simm(object):
    def __init__(self):
        self.conf=np.load('/home/marco/work/tesi/data/NewParameters/meanSSE.npy')
        o_rt=rise_time()
        ...
        self.m_conf=np.where(der==min(der))[0][0]    
        return
...
class second_derivative(object):
    ...
    def compute_n_peaks(self,der2,t):
        der2=abs(der2)
        der2=der2/max(der2)   
